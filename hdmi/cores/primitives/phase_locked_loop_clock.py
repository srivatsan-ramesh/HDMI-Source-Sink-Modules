...
def pll_clock_generator(clock_feedback_out, pll_clock0, pll_clock1, pll_clock2,
    ...
    global inst_count
    clock0_inst = clock_driver(pll_clock0, clock_fb_out_mult//clock0_divide)
    clock1_inst = clock_driver(pll_clock1, clock_fb_out_mult//clock1_divide)
    clock2_inst = clock_driver(pll_clock2, clock_fb_out_mult//clock2_divide)
    ...
    return clock0_inst, clock1_inst, clock2_inst, initialize
